...
import edu.sm.app.springai.service5.SmartHomeService; // Added SmartHomeService import
...
public class Ai5Controller {
  ...
  final private SmartHomeService smartHomeService; // Added SmartHomeService injection
  ...
  // Added SmartHomeService API endpoint
  @RequestMapping(value = "/smarthome-tools")
